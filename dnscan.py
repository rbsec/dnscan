...
def get_args():
    ...
    parser.add_argument('-z', '--zone-transfer', action="store_true", default=False, help='Only perform zone transfers', dest='zonetransfer', required=False)
    ...
    parser.add_argument('-m', '--max-depth', help="Maximal recursion depth (for brute-forcing)", dest='depth', required=False, type=int, default=100)
    ...
    parser.add_argument('-n', '--no-check', action="store_true", default=False, help='Don\'t check nameservers before scanning', dest='nocheck', required=False)
